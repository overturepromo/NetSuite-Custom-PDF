...
<body header="nlheader" header-height="15%" padding="0.5in 0.5in 0.5in 0.5in" size="Letter">
    &nbsp;
...
<thead>
	...
	<td align="center" colspan="3" style="font-weight: bold;border-top: 1px solid; border-bottom: 1px solid; border-right: 1px solid ">${invoice_summary.itemtotal@label}</td>
	<td align="center" colspan="3" style="font-weight: bold;border-top: 1px solid; border-bottom: 1px solid; border-right: 1px solid ">${invoice_summary.discounttotal@label}</td>
	<td align="center" colspan="3" style="font-weight: bold;border-top: 1px solid; border-bottom: 1px solid; border-right: 1px solid ">${invoice_summary.trantaxtotal@label}</td>
	<td align="center" colspan="3" style="font-weight: bold;border-top: 1px solid; border-bottom: 1px solid; border-right: 1px solid ">${invoice_summary.shippingcharge@label}</td>
	<td align="center" colspan="3" style="font-weight: bold;border-top: 1px solid; border-bottom: 1px solid; border-right: 1px solid ">${invoice_summary.handlingcharge@label}</td>
	...
	<td align="center" colspan="3" style="border-bottom: 1px solid; border-right: 1px solid">${invoice_summary.itemtotal}</td>
	<td align="center" colspan="3" style="border-bottom: 1px solid; border-right: 1px solid">${invoice_summary.discounttotal}</td>
	<td align="center" colspan="3" style="border-bottom: 1px solid; border-right: 1px solid">${invoice_summary.trantaxtotal}</td>
	<td align="center" colspan="3" style="border-bottom: 1px solid; border-right: 1px solid">${invoice_summary.shippingcharge}</td>
	<td align="center" colspan="3" style="border-bottom: 1px solid; border-right: 1px solid">${invoice_summary.handlingcharge}</td>
	<td align="right" colspan="3" style="border-bottom: 1px solid; border-right: 1px solid">${invoice_summary.fxamount}</td>
	</tr>
	</#list></table>

<table align="right" style="break-inside: avoid;"><tr style=" ">
	<td align="left" style="background-color: #d3d3d3; font-weight: bold; color: rgb(51, 51, 51); border-left: 1px solid; border-bottom: 1px solid; border-right: 1px solid; width: 120px;">${record.taxtotal@label}</td>
	<td align="right" style="border-bottom: 1px solid; border-right: 1px solid; width: 120px;">${record.taxtotal}</td>
	</tr>
	<#if record.shippingcost?has_content>
	<tr style=" ">
	<td align="left" style="background-color: #d3d3d3; font-weight: bold; color: rgb(51, 51, 51); border-left: 1px solid; border-bottom: 1px solid; border-right: 1px solid; width: 120px;">${record.shippingcost@label}</td>
	<td align="right" style="border-bottom: 1px solid; border-right: 1px solid; width: 120px;">${record.shippingcost}</td>
	</tr>
	</#if><#if record.handlingcost?has_content>
	<tr style=" ">
	<td align="left" style="background-color: #d3d3d3; font-weight: bold; color: rgb(51, 51, 51); border-left: 1px solid; border-bottom: 1px solid; border-right: 1px solid; width: 120px;">${record.handlingcost@label}</td>
	<td align="right" style="border-bottom: 1px solid; border-right: 1px solid; width: 120px;">${record.handlingcost}</td>
	</tr>
	</#if>
	<tr style=" ">
	<td align="left" style="background-color: #d3d3d3; font-weight: bold; color: rgb(51, 51, 51); border-left: 1px solid; border-bottom: 1px solid; border-right: 1px solid; width: 120px;">${record.total@label}</td>
	<td align="right" style="border-bottom: 1px solid; border-right: 1px solid; width: 120px;">${record.total}</td>
	</tr></table>
</#if>
</body>
</pdf>